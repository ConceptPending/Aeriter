...
%rebase base_template title=config.get("Settings", "title"), h1Title=config.get("Settings", "title"), description=config.get("Settings", "description"), subtitle=config.get("Settings", "subtitle")
