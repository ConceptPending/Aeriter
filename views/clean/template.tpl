...
%rebase base_template title=postTitle + " - " + config.get("Settings", "title"), h1Title=config.get("Settings", "title"), description=", ".join(tags), subtitle=config.get("Settings", "subtitle")
